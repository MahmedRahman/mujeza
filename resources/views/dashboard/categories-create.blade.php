...
@section('content')
    <section class="card">
        <h2 style="margin-top: 0; font-weight: 700;">إضافة فئة جديدة</h2>
        <a href="{{ route('categories.index') }}" style="display:inline-block; margin-bottom: 14px; text-decoration:none; border:1px solid #d1d5db; background:#fff; color:#111827; padding:8px 14px; border-radius:8px; font-weight:700;">
