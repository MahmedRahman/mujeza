    ...
    <section class="card">
        ...
        <form method="POST" action="{{ route('branches.update', $branch) }}">
            ...
            <div style="margin-bottom: 12px;">
                ...
                <textarea name="working_hours" rows="3" placeholder="مثال: يوميًا من 9:00 ص إلى 10:00 م ماعدا الجمعة" style="width:100%; border:1px solid #d1d5db; border-radius:8px; padding:10px; font-family:inherit;">{{ old('working_hours', $branch->working_hours) }}</textarea>
            </div>
