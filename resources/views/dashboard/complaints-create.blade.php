...
@section('title', 'إضافة شكوى/استفسار')
@section('page_title', 'إضافة شكوى/استفسار')

@section('content')
    <section class="card">
        <h2 style="margin-top: 0; font-weight: 700;">إضافة شكوى/استفسار</h2>
        <p style="margin-bottom: 14px; color: #4b5563; font-weight: 500;">
            أدخل العنوان والوصف ورقم التليفون.
        </p>
        ...
        <form method="POST" action="{{ route('complaints.store') }}">
            ...
            <div style="margin-bottom:12px;">
                ...
                <textarea name="description" rows="6" required style="width:100%; border:1px solid #d1d5db; border-radius:8px; padding:10px; font-family:inherit;">{{ old('description') }}</textarea>
            </div>
