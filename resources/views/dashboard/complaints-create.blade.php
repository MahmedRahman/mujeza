...
@section('title', 'إضافة شكوى')
@section('page_title', 'إضافة شكوى')

@section('content')
    <section class="card">
        <h2 style="margin-top: 0; font-weight: 700;">إضافة شكوى</h2>
        ...
        <form method="POST" action="{{ route('complaints.store') }}">
            ...
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:12px; margin-bottom:12px;">
                <div>
                    ...
                    <input name="remote_jid" type="text" value="{{ old('remote_jid') }}"
            ...
            <div style="margin-bottom:12px;">
                ...
                <textarea name="description" rows="6" required
                          style="width:100%; border:1px solid #d1d5db; border-radius:8px; padding:10px; font-family:inherit;">{{ old('description') }}</textarea>
            </div>
